...
class NewsViewModel : ViewModel(){
    ...
    fun commonMuslimNews() {
        ApiClient.ApiServiceProvider().getCommonNews()
    ...
    fun aboutAlQuranNews() {
        ApiClient.ApiServiceProvider().getAlQuranNews()
            .enqueue(object : Callback<NewsResponse> {
                override fun onResponse(
                    call: Call<NewsResponse>,
                    response: Response<NewsResponse>
    ...
    fun alJazeeraNews() {
        ApiClient.ApiServiceProvider().getAlJazeeraNews()
            .enqueue(object : Callback<NewsResponse> {
                override fun onResponse(
                    call: Call<NewsResponse>,
                    response: Response<NewsResponse>
    ...
    fun warningForMuslimNews() {
        ApiClient.ApiServiceProvider().getWarningforMuslimNews()
            .enqueue(object : Callback<NewsResponse> {
                override fun onResponse(
                    call: Call<NewsResponse>,
                    response: Response<NewsResponse>
    ...
    fun searchNews(query: String) {
        ApiClient.ApiServiceProvider().getSearchNews(query)
            .enqueue(object : Callback<NewsResponse> {
                override fun onResponse(
                    call: Call<NewsResponse>,
                    response: Response<NewsResponse>
